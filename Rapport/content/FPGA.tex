...
Ved 11 bits opløsning på PWM og brug af BASYS boardets interne clock på 50 [MHz] bliver PWM-frekvensen over det hørbare frekvensområde.
...
I PWM komponenten produceres PWM-signalerne på baggrund af duty cycle værdier modtaget vha. SPI. 
...
Encoderne på PTS er quadrature, er det muligt at bestemme både retning og tælle rotationer på motoren. 
...
FPGA'en fungerer som simpel slave i SPI-overførselen med mikrocontrolleren. FPGA'en holder styr på pan og tilts motorpositon samt producerer PWM-signalerne 
