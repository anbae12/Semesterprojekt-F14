...
cirkelperiferien. Dette projekt er afgrænset til et enkelt tilfælde - afskydning fra ”High-House” med pan-and-tilt systemet placeret på station 4.\todo[author=Anders]{Sidste sætning skal omformuleres.}\\
...
\label{fig:para_in_xy_plane}
\end{figure}
\todo[author=Anders]{Jeg ved ikke om denne skal bruges, men nu er den tegnet}
