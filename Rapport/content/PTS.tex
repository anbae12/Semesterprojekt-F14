...
ikke må overstige 1,02\degree\todo{2,04??}, hvilket gør systemet betragtes stadig som en helhed.
...
Overføringsfunktion for DC-motoren med antagelse om \(\omega\) (vinkelhastigheden) og dens tidsafledte er 0.
...
Der blev som input givet et rampesignal, der gik fra 0 \% duty cycle til næsten\todo{næsten???} 100 \% duty cycle
