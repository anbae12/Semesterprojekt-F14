...
og den resulterende overføringsfunktion findes i ligning \ref{eq:transOmega}.
\begin{equation}
...
vil gearingen i forholdet 1:3 gøre, at kvantiseringsintervallet af output-rotationen til rammerne,
er \(\frac{1}{1080}\).
...
Overføringsfunktionen for disse duty cycles %- motorspændingsfald konvertering ønskes til reguleringen. Det 
...
Måden den målte vinkel er blevet differentieret på er ved først at tilpasse en parabel
...
ca. \(\pm\) 12 \%, og for pan-systemet til ca. \(\pm\) 10 \%.\todo[inline,author=Mikael]{Opdatér dødzoner til de rigtige værdier!}
...
som vinkelbestemmelserne for hhv. tilt og pan og \(\rho\) er afstanden fra PTS til lerduen.
