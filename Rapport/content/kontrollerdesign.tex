...
\todo[inline,author=Mikael]{Opdatér bias når vi er helt færdige med PID-tuning!}
Bias er implementeret med en nedre duty cycle grænse på 0.97\% for pan og tilt.
Deres respektive øvre grænser er hhv. 11,72\% og 13,18\%.
Disse værdier er fundet eksperimentelt ved Trial-and-Error metoden under PID-justeringen.
Hvis controlleren returnerer en duty cycle mellem den nedre og øvre grænse, sættes duty cycle til dens øvre grænse.
