...
\end{figure}
\todo[inline,author=Mikael,color=green]{Nikolaj! Fiks figur \ref{fig:digitalkontroller1}! Den er for stor! Tak}
...
\end{figure}
\todo[inline,author=Mikael,color=green]{Nikolaj! Fiks figur \ref{fig:digitalkontroller2}! Den er for stor! Tak}
...
\begin{figure}[!th]
\centering
\begin{tikzpicture}[node distance=2.6cm,>=latex',scale=0.9]
...
\end{figure}
\todo[inline,author=Mikael,color=blue]{Nikolaj! Fiks figur \ref{fig:digitalkontroller3}! Den er lidt for stor! Tak}
...
PWM-duty cycles med en størrelse på under 1 \%.\todo[inline,author=Mikael]{Hvorfor 1 \%???}
