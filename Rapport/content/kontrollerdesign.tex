...
hvis \(f_s\) er et heltalsmultiplum af den første samplings frekvens (120 [Hz])\todo[author=Anders]{eventuelt: frekvens på 120 [Hz].} \citep{dsp}\todo[author=Anders]{Konkret side i henvisningen.}.
