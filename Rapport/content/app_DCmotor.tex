...
var et mindre decimal i de ni første, ${V_{m}}$.}
\begin{figure}[th!]
	\centering
...
\begin{equation}
	...
	\label{eq:effekt}
 \end{equation}
>>>>>>> c5104452880841685edf700bce33975684c0beea
\subsubsection{Fremgangsmåde}
\paragraph{Metode 1}
...
(vinkelhastigheden kan omregnes til SI-enheder, i det det vides, at der er 360 ticks pr. omgang\todo{Kilde}).
...
\begin{equation}
	...
	\label{eq:Tres0}
 \end{equation}
Dette kraftmoment kan også udtrykkes som kraftmomentet på rotoren fra snoren, $T_op$,
...
Kraftmomentet $T_op$ kan udtrykkes som rotorens radius $r$ ganget med snorkraften, $F_snor$,
