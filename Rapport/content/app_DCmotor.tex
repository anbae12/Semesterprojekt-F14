...
Proportionalitetskonstanterne \(K_b\) og \(K_t\) har i SI-enheder samme numeriske værdi \citep{matlabmodel}
...
\(R_m\) er ved lineær regression beregnet til 5,21 \([\Omega]\). \todo[inline]{Flere decimaler?}
...
blevet bestemt til 5,21 \([\Omega]\). \todo[inline]{Flere decimaler?}
...
\begin{equation}
 ...
 \end{equation}
Tidskonstanten er et mål for tiden det tager systemet at opnå ca. 63,2 \% af slutværdien.\todo[inline]{D\&B-kilde}
...
og oscilloskopet er af typen Agilent Technologies DSO-X 2024A.
...
\begin{equation}
	\left|T_f\right|=J_m\left|\alpha{ned}\right|
	\label{eq:Tf0}
 \end{equation}
