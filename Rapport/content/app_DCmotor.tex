...
\begin{align}
	T_m(t)&=J\cdot\frac{\mathrm d}{\mathrm d t} \big(\omega(t) \big)+T_f\\
		&=J\cdot\frac{\mathrm d}{\mathrm d t} \big(\omega(t) \big)+B\cdot\omega(t)
	\label{eq:Tm_leveret} 
 \end{align}
...
\begin{equation}
	i_m(t)=\frac{J}{K_t}\cdot{}\frac{\mathrm d}{\mathrm d t} \big(\omega(t) \big)+\frac{B}{K_t}\cdot{}\omega(t)
	\label{eq:im} 
 \end{equation}
Dennes tidsafledte er givet ved ligning \ref{eq:dim}.
\begin{equation}
	\frac{\mathrm d}{\mathrm d t} \big(i_m(t) \big)=\frac{J}{K_t}\cdot{}\frac{\mathrm d^2}{\mathrm d t^2} \big(\omega(t) \big)
		+\frac{B}{K_t}\cdot{}\frac{\mathrm d}{\mathrm d t} \big(\omega(t) \big)
	\label{eq:dim} 
 \end{equation}
...
\begin{equation}
	V_m(t)=\frac{L_m\cdot{}\left(J_L+J_m\right)}{K_t}\cdot{}\frac{\mathrm d^2}{\mathrm d t^2} \big(\omega(t) \big)
		+\frac{R_m\cdot{}\left(J_L+J_m\right)+L_m\cdot{}B}{K_t}\cdot{}\frac{\mathrm d}{\mathrm d t} \big(\omega(t) \big)
		+\left(K_b+\frac{R_m\cdot{}B}{K_t}\right)\cdot{}\omega(t)
...
\begin{equation}
 ...
 \end{equation}
\begin{equation}
	V_m(t)=k_1\cdot{}\frac{\mathrm d^2}{\mathrm d t^2} \big(\omega(t) \big)
		+k_2\cdot{}\frac{\mathrm d}{\mathrm d t} \big(\omega(t) \big)
		+k_3\cdot{}\omega(t)
