...
\centering
\begin{circuitikz}
\input{graphics/Mangleratblivetegnet.tex}  
\end{circuitikz}
...
\centering
\begin{circuitikz}
\input{graphics/Mangleratblivetegnet2.tex}  
\end{circuitikz}
...
\centering
\begin{circuitikz}
\input{graphics/Mangleratblivetegnet3.tex}  
\end{circuitikz}
% \includegraphics[width=0.1\textwidth]{./graphics/Mangleratblivetegnet3}
%\begin{tikzpicture}[scale=2]
%\include*{./graphics/}
%\end{tikzpicture}
\caption[Rotationslåst motor med \(R_s1\)]{Rotationslåst motor, i serie med en modstand \(R_s1\) og en AC-forsyning.}
