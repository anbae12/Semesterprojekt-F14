...
\todo[inline, author=Michael]{Jeg kan ikke finde ud af at skrive følgende afsnit. HELP MEAY!}
...
\todo[inline, author=Michael]{Var sådan set blevet enige med Mikkel, Åse og Nikolaj om at bruge de høje figurer... GRR! }
\todo[inline, color=pink,author=Mikkel]{Husk nu det gode humør ;)}
\todo[inline, color=yellow,author=Anders]{Vi tager den i morgen ;)}
...
\todo[inline, color = green, author = Nikolaj]{Jeg har set at dette er plottet, skal det overhovedet med eller var det bare for sjov?}
...
\todo[inline, color = green, author = Nikolaj]{Realtidsafviklingen skal også måles... Men er det ca det her vi vil have til at stå eller skal der mere om dette?}
