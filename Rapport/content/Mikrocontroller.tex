...
Intervallet mellem hver afvikling af blev målt for 240 afviklinger, og resultaterne er vist i tabel \ref{tb:ctrltasktimingtest}.

\begin{table}[h!]
\centering
\begin{tabu}{c|[1.25pt]c|c|c|c}
 & Max:  & Min: & Median: & Gennemsnit:  \\ \tabucline[1.25pt]{-}
Målt interval: & 1,674 [ms] & 1,657 [ms] & 1,667 [ms] & 1,667 [ms] \\ \hline 
Afvigelse: & 6,933 [\micro s] & 9,067 [\micro s] & 0,533 [\micro s] & 0,005 [\micro s] \\
\end{tabu} 
%\begin{tabular}{|c|c|c|c|c|}\hline 
% & Max:  & Min: & Median: & Gennemsnit: \\ \hline 
%Målt interval: & 1,674 [ms] & 1,657 [ms] & 1,667 [ms] & 1,667 [ms] \\ \hline 
%Afvigelse: & 6,933 [\micro s] & 9,067 [\micro s] & 0,533 [\micro s] & 0,005 [\micro s] \\\hline 
%\end{tabular} 
