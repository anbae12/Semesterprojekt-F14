...
Den udleverede mikrocontroller er en 32 bit Stellaris LM3S6965, baseret på en ARM Cortex M3 kerne. Den opererer ved 50 mHz\todo[author=Anders]{Det er vel [MHz] i stedet for [mHz]} og bruger Thump 2 instruktionssættet. Den indeholder 256 KB\todo[author=Anders]{Det er vel [kB] i stedet for [KB]} flash hukommelse samt 64 KB SRAM. 
...
\begin{itemize}
\itemsep1pt
	\item CoOS\footnote{coocox.com/CoOS.htm} \todo[inline,Author=Anders]{Jeg synes det er pænere hvis der bruges \url{www.coocox.com/CoOS.htm} i fodnoten.}
...
\begin{description}
	\item[Uart send] Tager indholdet fra uart\_ out\_ buffer og ligger dem ind i UART-modulets hardware FIFO buffer. Dette er nødvendigt fordi hw. bufferen kun indeholder 16 pladser\footnote{Jævnfør s. 430 i LM3S6965}.\todo[inline,author=Anders]{Brug \citep[Side. 430]{kilde fra litteratur.bib},, det synes jeg er pænere.}
