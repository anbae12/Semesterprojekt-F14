...
der maks. afviger 0,9\degree{} efter \(t_s\).\todo[inline,author=Mikael]{Det er ikke 0,9 grader, og Mikael skal nok få det rettet jf. MATLAB scriptet.}
...
\todo[inline,author=Mikael]{Der mangler en del om at vores data faktisk godt kan bruges til noget. Hvis man skyder på det rigtige tidspunkt? etc.}
