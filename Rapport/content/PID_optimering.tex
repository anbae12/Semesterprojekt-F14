...
\(K_u\) og \(T_u\) er bestemt ud fra hhv. pans og tilts diskretiserende transferfunktioner, ligning \ref{eq:pantiltdiskretiserendetf} og med et \textbf{lækkert MATLAB script.}\todo[author=Anders]{Skriv noget bedre.}
\begin{itemize}
...
\todo[inline,author=ALLE]{Idet Ziegler-Nichols giver P.O. på cirka 60 \%, skal keofficienterne optimeres manuelt.}