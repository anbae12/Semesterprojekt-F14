...
\begin{figure}[h!]
\centering
\subfloat[Lerduens højde som funktion af afstanden til D.\label{fig:PID_test14_plot_pan}]{%
	\includegraphics[width=0.5\textwidth]{./graphics/error_pan.eps}
}
\subfloat[Lerduens bane projekteret på xy-planet.\label{fig:PID_test14_plot_tilt}]{%
	\includegraphics[width=0.5\textwidth]{./graphics/error_tilt.eps}
}
...
\todo[author=Anders,inline,color=yellow]{Jeg tænker optimeringprocessen skal beskrives her.}
\subsection{PTS verifikation}
\todo[author=Anders,inline,color=yellow]{Jeg tænker verifikationen kan beskrives her, idet jeg synes det hænger sammen.}