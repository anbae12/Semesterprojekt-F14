...
Det giver koordinatsættene (20,11 ; 4,57) og (52 ; 0). Vha. disse bestemmelser er udtrykkes \(\theta\) og \(v_0\)\todo{eventuel lige en formel til bestemmelsen.}.
...
\end{split}
\end{align}
\todo[inline]{nedenstående ligning skal tjekkes op.}
\begin{align}
\begin{split}
...
For at finde ud af hvornår lerduen rammer jorden, sættes \(y(t) = 0\). Det giver:
...
Stedvektoren for lerduens position i 3D kan skrives (ved \(\alpha = 15,872 \degree\))\todo{Hvordan og hvor finder vi alfa?}. 
