...
\usepackage{pgfplots}
%\pgfplotsset{compat=1.8} %Den nyeste version af pgfplot. Undersøttes ikke af Anders' typesetter.
\pgfplotsset{compat=1.6} %En gammel version af pgfplot. Burde være understøttet på alle maskiner.
