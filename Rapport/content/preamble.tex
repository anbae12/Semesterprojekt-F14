...
% Antal lag i indholdsfortegenlse.
%\usepackage[toc,lof,lot]{multitoc} %For multicolumn table of contents
...
\usepackage{graphicx} % den skal bruges til MATLAB det skal hedde .eps
\usepackage{mathtools}
