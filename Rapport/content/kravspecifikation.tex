...
ift. xy-planet jf. figur \ref{fig:ES}\footnote{Beregningerne bag kasteparablen findes i appendiks \ref{sec:udregning_af_parabel}.}. 
...
\label{eq:ks:vektorparabel3d}
\end{equation}
%En gennemgang af beregningerne der ligger bag kasteparablen findes i appendiks \ref{sec:udregning_af_parabel}.
