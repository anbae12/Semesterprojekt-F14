...
\end{figure}
\todo[inline, color = pink,author = Mikkel]{Er det ikke ligegyldigt at vi kan affyre to skud, hvis kun ét er tilladt?}
Det anslås, at man kan nå at affyre to skud mellem tidspunktet,
...
\todo[inline, color = pink,author = Mikkel]{ Ligning 2.4 gælder vel kun ved antagelse af lineær spredning?}
