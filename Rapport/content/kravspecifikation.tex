...
hvor lerduen når toppunktet og nedslagstidspunktet (når lerduen når low house), se ligning \ref{eq:ks:nedslagstid}.
...
\end{align}
Der er altså et krav om at geværet peger på lerduen med en præcision på \(\pm 1 \degree\).
Dette krav gælder for både pan-rammens vinkel (\(\phi\)) og tilt-rammens vinkel (\(\theta\)).

Tilt-rammen kan bevæge sig frit,
men pan-rammen kan pga. en stopklods kun rotere
\(170 \degree\)\todo[inline,author=Mikael]{Denne værdi er ukorrekt! Mål efter!}.
