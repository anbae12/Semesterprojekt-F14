...
\node[task_description](Display_Debug) [right of= display] {Display};
\node[task_description](Clock_scaler) [right of= Display_Debug] {Clock scaler};
\node[task_description](Tic_counter) [yshift=2.5cm,below of= Display_Debug] {Tick counter};
...
%Mikkel
\node[task_description](Tic_reset)[yshift=2.5cm,,below of= Tic_counter] {Tick reset};
\node[task_title](Hall_sensor) [left of= Tic_reset] {Hall sensor};
\path[->] (Hall_sensor) edge[bend left=0] (Tic_reset);
\path[<->] (Tic_reset) edge[bend left=0] (Tic_counter);
%Mikkel

\node[task_description](PWM) [yshift=2.5cm,,below of= Tic_reset] {PWM};
...
\node[task_description](output_Decoder) [yshift=-0.75cm,right of= SPI] {Output encoder};
