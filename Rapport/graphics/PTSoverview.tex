\node [draw, fill=green!40, rectangle, minimum height=4em, minimum width=2.5em] (mikrocontroller) {Mikrocontroller};
\node [draw, fill=blue!20, rectangle, minimum height=8em, minimum width=2.5em, right of=mikrocontroller, xshift=2cm] (FPGA) {FPGA};
\node [blockgreen, below of=mikrocontroller,xshift=1.5cm, yshift=-2cm] (brugerinput) {Bruger input};
\node [blockgreen, below of=mikrocontroller, xshift=-1.5cm, yshift=-2cm] (brugerfeedback) {Bruger feedback};
