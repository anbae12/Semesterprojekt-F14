...
\draw[dashed, blue] (1,6.5)--(1,7);
\draw[dashed, blue] (6,6.5)--(6,7);
\draw[dashed, blue] (1,1)--(1,1.5);
\draw[dashed, blue] (6,1)--(6,1.5);

\draw[dashed, red] (0.5,7)--(0.5,7.5);
\draw[dashed, red] (6.5,7)--(6.5,7.5);
...
\draw[dashed, blue] (-0.5,0.5)--(0,0.5);
\draw[dashed, blue] (7,0.5)--(7.5,0.5);

\draw[dashed, red] (-0.5,-0.5)--(-0.5,0);
\draw[dashed, red] (7.5,-0.5)--(7.5,0);
\draw [decorate,decoration={brace,amplitude=10pt},xshift=0pt,yshift=0pt]
(7.5,-0.5)--(-0.5,-0.5);
