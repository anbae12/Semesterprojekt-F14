...
to ++(0,-3)
to ++(-6,0)
%node[draw, rectangle, minimum height = 2cm, minimum width = 0.5cm, fill=black!10] (rotor_block) {}
...
%(rotor_block) |- (0,0)
%(0,0) node[text width=2cm, text centered] (circ) {} 
;
%\draw[->,thick] (circ.45) ++(2,0) arc(270:90:-5mm) ;
%\draw (circ.270) ++(2.3,0) node {\( i_m \)};
